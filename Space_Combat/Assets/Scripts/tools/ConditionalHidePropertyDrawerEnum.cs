...
public class ConditionalHideEnumPropertyDrawer : PropertyDrawer
{
    ...
    {
        ConditionalHideEnumAttribute condHAtt = (ConditionalHideEnumAttribute)attribute;
        bool enabled = GetConditionalHideEnumAttributeResult(condHAtt, property);
    ...
    bool GetConditionalHideEnumAttributeResult(ConditionalHideEnumAttribute condHAtt, SerializedProperty property)
    {
    ...
    bool CheckPropertyType(ConditionalHideEnumAttribute condHAtt, SerializedProperty sourcePropertyValue)
    {
